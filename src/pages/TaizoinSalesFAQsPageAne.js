...
import styles from "./TaizoinSalesFAQsPageAne.module.css";

const TaizoinSalesFAQsPageAne = () => {
  ...
  return (
    <>
      <div className={styles.taizoinSalesFaqsPageAne}>
          ...
          <div className={styles.mainBodyMachineOperatorsBg}>
            <div className={styles.machineOperatorsBgSowmiyaI}>
              ...
              <div className={styles.sowmiyaIntroSection}>
                  ...
                  <div className={styles.sowiyaNameCard}>
                    ...
                    <div className={styles.sowiyaNameCard2}>
                      <div className={styles.sowiyaNameRole}>
                        <div className={styles.aneesFatimaAzeezullah}>
                          Anees Fatima Azeezullah
                        </div>
                ...
                <img
                  className={styles.aneesFatima1}
                  alt=""
                  src="/anees-fatima-1@2x.png"
                />
              </div>
            </div>
            <img
              className={styles.lessScreensizeImageAneesFa}
              alt=""
              src="/960-less-screensize-image-anees-fatima-n2-1@2x.png"
            />
          </div>
            ...
            >
              ...
              <button className={styles.postAJobFloatingButton}>
                <img
                  ...
                  alt=""
                  src="/calendar1196svgrepocom-1.svg"
                />
              </button>
            </div>
            <div
                  ...
                  <button className={styles.faqVideo1Thumbnail}>
                    <div className={styles.video1PlayButton}>
                      ...
                      <img
                        ...
                        alt=""
                        src="/playbuttonsvgrepocom-1.svg"
                      />
                    </div>
                  </button>
                ...
                <div className={styles.faqVideo2ThumbnailParent}>
                  <button className={styles.faqVideo2Thumbnail}>
                    <img
                      ...
                      alt=""
                      src="/faq-video-2-play-button.svg"
                    />
                  </button>
                  <div className={styles.faqVideo1TitleText}>
                ...
                <div className={styles.faqVideo2ThumbnailParent}>
                  <button className={styles.faqVideo3Thumbnail}>
                    <img
                      className={styles.video1PlayButton}
                      alt=""
                      src="/faq-video-3-play-button.svg"
                    />
                  </button>
                  <div className={styles.faqVideo1TitleText}>
                ...
                <div className={styles.faqVideo2ThumbnailParent}>
                  <button className={styles.faqVideo4Thumbnail}>
                    <img
                      className={styles.video1PlayButton}
                      alt=""
                      src="/faq-video-4-play-button.svg"
                    />
                  </button>
                  <div className={styles.faqVideo1TitleText}>
...
export default TaizoinSalesFAQsPageAne;
